...
formatted0 <- tab0 %>%
  ...
  tidyr::complete(birthyear) %>%
  select(birthyear, n, "Birthweight (g)", "Gestational Age (weeks)", female, male, Stillbirth, Preterm_birth, Low_birth_weight, Macrosomia)
formatted0
...
formatted1 <- tab1 %>%
  ...
  tidyr::complete(birthyear) %>%
  select(birthyear, n, "Birthweight (g)", "Gestational Age (weeks)", female, male, Preterm_birth, Low_birth_weight, Macrosomia)
formatted1
