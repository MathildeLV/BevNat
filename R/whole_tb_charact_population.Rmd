...
formatteda <- taba %>%
  mutate(n=n,
        ...
        "Missing or Oceania" = round({perc_mat_nat_cat_2_NA}, digits=2),
  ...
  select(birthyear, n, "Maternal age (years)", "(10-20]", "(20-25]", "(25-30]", "(30-35]", "(35-40]", "> 40",  "1", "2", "3", ">3", "missing", "Switzerland", "Africa", "Asia", "Europe", "Northern America", "Southern and Central America", "Missing or Oceania", "Rural", "Urban", "German or Romansh", "French", "Italian", "Mean SSEP")
formatteda
