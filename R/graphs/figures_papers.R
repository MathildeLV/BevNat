...
BW_figure1 <- ggarrange(plot_BW_time, plot_BW_SEP, plot_BW_nationality, plot_BW_language_region,
                         ...
                         ncol = 2, nrow = 2) 
BW_figure1
ggsave("BW_figure1.pdf", BW_figure1, path = here("output/stratification/graphs"))
ggsave("BW_figure2.jpg", BW_figure1, path = here("output/stratification/graphs"))
...
PTB_figure2 <- ggarrange(plot_PTB, ggplot_PTB_SEP, ggplot_PTB_nationality, ggplot_PTB_Language_region,
                    ...
                    ncol = 2, nrow = 2)
PTB_figure2
ggsave("PTB_figure2.pdf", PTB_figure2, path = here("output/stratification/graphs"))
ggsave("PTB_figure2.jpg", PTB_figure2, path = here("output/stratification/graphs"))
...
BW_supplfig_1 <- ggarrange(plot_BW_GA, plot_BW_mat_age, plot_BW_month, plot_BW_ssep, plot_BW_altitude,
                          ...
                          ncol = 3, nrow = 2) 
BW_supplfig_1
ggsave("BW_supplfig_1.pdf", BW_supplfig_1, path = here("output/stratification/graphs"))
ggsave("BW_supplfig_1.jpg", BW_supplfig_1, path = here("output/stratification/graphs"))
...
PTB_supplfig_2 <- ggarrange(plot_PTB_BW, plot_PTB_mat_age, plot_PTB_seasonality, plot_PTB_SSEP, plot_PTB_altitude,
                          ...
                          ncol = 3, nrow = 2) 
PTB_supplfig_2
ggsave("PTB_supplfig_2.pdf", PTB_supplfig_2, path = here("output/stratification/graphs"))
ggsave("PTB_supplfig_2.jpg", PTB_supplfig_2, path = here("output/stratification/graphs"))
...
SB_supplfig_3 <- ggarrange(plot_PTB_BW, plot_PTB_mat_age, plot_PTB_seasonality, plot_PTB_SSEP, plot_PTB_altitude,
                           ...
                           ncol = 3, nrow = 2) 
SB_supplfig_3
ggsave("SB_supplfig_3.pdf", SB_supplfig_3, path = here("output/stratification/graphs"))
ggsave("SB_supplfig_3.jpg", SB_supplfig_3, path = here("output/stratification/graphs"))
