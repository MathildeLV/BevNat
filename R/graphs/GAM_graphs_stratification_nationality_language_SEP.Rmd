---
title: "GAM stratified by maternal nationality, SSEP or Language Region"
...
plot_m_BW_bam_L_SSEP1 <- GAM_plot_function(m_BW_bam_L_SSEP1) %>%
  mutate(SEP="low")
plot_m_BW_bam_M_SSEP1 <- GAM_plot_function(m_BW_bam_M_SSEP1) %>%
  mutate(SEP="medium")
plot_m_BW_bam_H_SSEP1 <- GAM_plot_function(m_BW_bam_H_SSEP1) %>%
  mutate(SEP="high")
```
...
#function to extract the plot information
plot_m_BW_bam_swiss <- GAM_plot_function(m_BW_bam_swiss) %>%
  mutate(nationality="Swiss")
plot_m_BW_bam_Afr <- GAM_plot_function(m_BW_bam_Afr) %>%
  mutate(nationality="African")
plot_m_BW_bam_Asi <- GAM_plot_function(m_BW_bam_Asi) %>%
  mutate(nationality="Asian")
plot_m_BW_bam_Eur <- GAM_plot_function(m_BW_bam_Eur) %>%
  mutate(nationality="European")
plot_m_BW_bam_Nort_Am <- GAM_plot_function(m_BW_bam_Nort_Am) %>%
  mutate(nationality="Northern American")
plot_m_BW_bam_S_C_Am <- GAM_plot_function(m_BW_bam_S_C_Am) %>%
...
plot_m_BW_bam_German <- GAM_plot_function(m_BW_bam_German) %>%
  mutate(language_region="German")
plot_m_BW_bam_French <- GAM_plot_function(m_BW_bam_French) %>%
  mutate(language_region="French")
plot_m_BW_bam_Italian <- GAM_plot_function(m_BW_bam_Italian) %>%
