...
```{r}
m_BW_bam5_2_SEP_cat3 <- bam(BW ~ s(GA_weeks) +  s(mat_age) + s(birth_Y_M_num) + s(month, bs="cc") + s(mean_Alt_mean2)+ parity_cat + sex + Urban3 + + mean_ssep2_cat3 + Language + mother_nationality_cat2 + civil_status3 + HW, data=bevn_eco_in7)  
...
```{r}
m_BW_bam_H_SSEP3 <- bam(BW ~ s(GA_weeks) +  s(mat_age) + s(birth_Y_M_num) + s(month, bs="cc") + s(mean_Alt_mean2)+ parity_cat + sex + Urban3 + Language + mother_nationality_cat2 + civil_status3 + HW, data=bevn_eco_in7_H_SSEP2)  
...
```{r}
m_BW_bam_L_SSEP3 <- bam(BW ~ s(GA_weeks) +  s(mat_age) + s(birth_Y_M_num) + s(month, bs="cc") + s(mean_Alt_mean2)+ parity_cat + sex + Urban3 + Language + mother_nationality_cat2  + civil_status3 + HW, data=bevn_eco_in7_L_SSEP3)  
  summary(bevn_eco_in7_L_SSEP3)
...
```{r}
m_BW_bam_M_SSEP3 <- bam(BW ~ s(GA_weeks) +  s(mat_age) + s(birth_Y_M_num) + s(month, bs="cc") + s(mean_Alt_mean2)+ parity_cat + sex + Urban3 + Language + mother_nationality_cat2 + civil_status3 + HW, data=bevn_eco_in7_M_SSEP3)  
