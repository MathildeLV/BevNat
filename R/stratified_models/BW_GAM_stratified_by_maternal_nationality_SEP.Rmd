---
title: "BW GAM stratified by maternal nationality and interaction SEP"
...
```{r}
  m_BW_bam_SEP_int_nation <- bam(BW ~s(GA_weeks) + s(mat_age) + s(birth_Y_M_num) + s(month, bs="cc") +  s(mean_ssep2, by=mother_nationality_cat2) + s(mean_Alt_mean2)+ parity_cat + sex  +  Urban3 + Language + mother_nationality_cat2 + civil_status3 + HW +
GR + COVID_first_wave + COVID_second_wave, data=bevn_eco_in7)
  ...
  beta <- coef(m_BW_bam_SEP_int_nation)
  Vb <- vcov(m_BW_bam_SEP_int_nation, unconditional = TRUE)
  se <- sqrt(diag(Vb))
  n <- 1184367
  d <- (abs(beta)/(sqrt(n)*se))
  my.ci <- data.frame(cbind(beta, lci = beta-1.96*se, uci = beta + 1.96*se, d))
...
m_BW_bam_swiss <- bam(BW ~ s(GA_weeks) +  s(mat_age) + s(birth_Y_M_num) + s(month, bs="cc") + s(mean_ssep2) + s(mean_Alt_mean2)+ parity_cat + sex + Urban3 + Language + civil_status3 + HW + GR + COVID_first_wave + COVID_second_wave, data=bevn_eco_in7_Swiss)  
  ...
  plot(m_BW_bam_swiss, select=1, ylim=c(0, 4100),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_swiss)[1]) #GA
  plot(m_BW_bam_swiss, select=2, ylim=c(3200, 3400),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_swiss)[1]) #mat age
  plot(m_BW_bam_swiss, select=3, ylim=c(3290, 3490),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_swiss)[1],  xlab  = "1 : 2007-01,     25: 2009-01,     50: 2011-02,    75: 2013-03,   100: 2015-04,    125: 2017-05, 150: 2019-06") #birth_Y_M_num
  plot(m_BW_bam_swiss, select=4, ylim=c(3330, 3365),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_swiss)[1]) #month
...
```{r}
  #  n <- 731225
  tab_m_BW_Swiss <- round(head(estimates_cont(m_BW_bam_swiss, 731225), 13), 2)
  tab_m_BW_Swiss
```
...
m_BW_bam_Afr <- bam(BW ~ s(GA_weeks) +  s(mat_age) + s(birth_Y_M_num) + s(month, bs="cc") + s(mean_ssep2) + s(mean_Alt_mean2)+ parity_cat + sex + Urban3 + Language + civil_status3 + HW + GR + COVID_first_wave + COVID_second_wave, data=bevn_eco_in7_Afr)  
  ...
  plot(m_BW_bam_Afr, select=1, ylim=c(0, 4100),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_Afr)[1]) #GA
  plot(m_BW_bam_Afr, select=2, ylim=c(3200, 3400),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_Afr)[1]) #mat age
  plot(m_BW_bam_Afr, select=3, ylim=c(3290, 3490),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_Afr)[1],  xlab  = "1 : 2007-01,     25: 2009-01,     50: 2011-02,    75: 2013-03,   100: 2015-04,    125: 2017-05, 150: 2019-06") #birth_Y_M_num
  plot(m_BW_bam_Afr, select=4, ylim=c(3350, 3365),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_Afr)[1]) #month
...
```{r}
  #  n <- 34388
  tab_m_BW_Afr <- round(head(estimates_cont(m_BW_bam_Afr, 34388), 13), 2)
  tab_m_BW_Afr
```
...
m_BW_bam_Asi <- bam(BW ~ s(GA_weeks) +  s(mat_age) + s(birth_Y_M_num) + s(month, bs="cc") + s(mean_ssep2) + s(mean_Alt_mean2)+ parity_cat + sex + Urban3 + Language + civil_status3 + HW + GR + COVID_first_wave + COVID_second_wave, data=bevn_eco_in7_Asi)  
  ...
  plot(m_BW_bam_Asi, select=3, ylim=c(3290, 3490),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_Asi)[1],  xlab  = "1 : 2007-01,     25: 2009-01,     50: 2011-02,    75: 2013-03,   100: 2015-04,    125: 2017-05, 150: 2019-06") #birth_Y_M_num
...
```{r}
  #  n <- 41664
  tab_m_BW_Asi <- round(head(estimates_cont(m_BW_bam_Asi, 41664), 13), 2)
  tab_m_BW_Asi
```
...
m_BW_bam_Eur <- bam(BW ~ s(GA_weeks) +  s(mat_age) + s(birth_Y_M_num) + s(month, bs="cc") + s(mean_ssep2) + s(mean_Alt_mean2)+ parity_cat + sex + Urban3 + Language + civil_status3 + HW + GR + COVID_first_wave + COVID_second_wave, data=bevn_eco_in7_Eur)  
  ...
  plot(m_BW_bam_Eur, select=3, ylim=c(3290, 3490),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_Eur)[1],  xlab  = "1 : 2007-01,     25: 2009-01,     50: 2011-02,    75: 2013-03,   100: 2015-04,    125: 2017-05, 150: 2019-06") #birth_Y_M_num
...
```{r}
  #  n <- 348490
  tab_m_BW_Eur <- round(head(estimates_cont(m_BW_bam_Eur, 348490), 13), 2)
  tab_m_BW_Eur
```
...
m_BW_bam_Nort_Am <- bam(BW ~ s(GA_weeks) +  s(mat_age) + s(birth_Y_M_num) + s(month, bs="cc") + s(mean_ssep2) + s(mean_Alt_mean2)+ parity_cat + sex + Urban3 + Language + civil_status3 + HW + GR + COVID_first_wave + COVID_second_wave, data=bevn_eco_in7_Nort_Am)  
  ...
  plot(m_BW_bam_Nort_Am, select=3, ylim=c(3290, 3490),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_Nort_Am)[1],  xlab  = "1 : 2007-01,     25: 2009-01,     50: 2011-02,    75: 2013-03,   100: 2015-04,    125: 2017-05, 150: 2019-06") #birth_Y_M_num
...
```{r}
  #  n <- 7017
  tab_m_BW_Nort_Am <- round(head(estimates_cont(m_BW_bam_Nort_Am, 7017), 13), 2)
  tab_m_BW_Nort_Am
```
...
m_BW_bam_S_C_Am <- bam(BW ~ s(GA_weeks) +  s(mat_age) + s(birth_Y_M_num) + s(month, bs="cc") + s(mean_ssep2) + s(mean_Alt_mean2)+ parity_cat + sex + Urban3 + Language + civil_status3 + HW + GR + COVID_first_wave + COVID_second_wave, data=bevn_eco_in7_S_C_Am)  
  ...
  plot(m_BW_bam_S_C_Am, select=3, ylim=c(3290, 3490),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_S_C_Am)[1],  xlab  = "1 : 2007-01,     25: 2009-01,     50: 2011-02,    75: 2013-03,   100: 2015-04,    125: 2017-05, 150: 2019-06") #birth_Y_M_num
  plot(m_BW_bam_S_C_Am, select=4, ylim=c(3330, 3360),shade = TRUE, shade.col = "lightblue",  shift = coef(m_BW_bam_S_C_Am)[1]) #month
...
```{r}
  #  n <- 21583
  tab_m_BW_S_C_Am <- round(head(estimates_cont(m_BW_bam_S_C_Am, 7017), 13), 2)
  tab_m_BW_S_C_Am
```
