...
```{r}
  #  n <- 847456
  tab_m_BW_German <- round(head(estimates_cont(m_BW_bam_German, 847456), 16), 2)
  tab_m_BW_German
```
...
```{r}
  #  n <- 295032
  tab_m_BW_French <- round(head(estimates_cont(m_BW_bam_French, 295032), 16), 2)
  tab_m_BW_French
```
...
```{r}
  #  n <- 41879
  tab_m_BW_Italian <- round(head(estimates_cont(m_BW_bam_Italian, 41879), 16), 2)
  tab_m_BW_Italian
```
