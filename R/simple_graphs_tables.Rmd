...
BW_years <- lm(Kind..Gewicht.in.Gramm~Ereignisjahr, data=bevn_eco)
summary(BW_years)
##ggplot(bevn_eco, aes(x=Ereignisjahr, y=Kind..Gewicht.in.Gramm)) ##doesnt work
...
##ggplot(bevn_eco, aes(x=Ereignisjahr, y=meanBW)) ##doesnt work


# BW_time3 <- lm(Kind..Gewicht.in.Gramm~year+month, data=bevn_eco) ##doesnt work
BW_time3 <- lm(Kind..Gewicht.in.Gramm~ factor(Ereignisjahr)+factor(Ereignismonat), data=bevn_eco) ##to not interpret too much
summary(BW_time3)

BW_time2 <- lm(Kind..Gewicht.in.Gramm~birthdate2, data=bevn_eco)
summary(BW_time2)
```
