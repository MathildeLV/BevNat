...
```{r}
  m_BW_bam_2009_2 <- bam(BW ~ s(GA_weeks) +  s(mat_age, k=7) + s(birth_Y_M_num) + parity_cat + sex + Urban3  + Language + mother_nationality_cat2 + mean_ssep2, data=bevn_eco_in7_2008_10)
