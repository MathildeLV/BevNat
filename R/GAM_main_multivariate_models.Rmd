...
BW_estimates_main_gt <- BW_main_gt%>%
  gtsave(here("output/tables_for_paper", "BW_estimates_categ_and_smooth_main_gt_with_pvalue.html"))
BW_estimates_main_gt <- BW_main_gt%>%
  gtsave(here("output/tables_for_paper", "BW_estimates_categ_and_smooth_main_gt_with_pvalue.docx"))
```
...
SB_estimates_main_gt <- SB_main_gt%>%
  gtsave(here("output/tables_for_paper", "SB_estimates_categ_and_smooth_main_gt_with_pvalue.html"))
SB_estimates_main_gt <- SB_main_gt%>%
  gtsave(here("output/tables_for_paper", "SB_estimates_categ_and_smooth_main_gt_with_pvalue.docx"))
```
...
PTB_estimates_main_gt <- PTB_main_gt%>%
  gtsave(here("output/tables_for_paper", "PTB_estimates_categ_and_smooth_main_gt_with_pvalue.html"))
PTB_estimates_main_gt <- PTB_main_gt%>%
  gtsave(here("output/tables_for_paper", "PTB_estimates_categ_and_smooth_main_gt_with_pvalue.docx"))
```